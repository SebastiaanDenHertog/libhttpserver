...
namespace httpserver
{
    ...
    namespace details
    {
        ...
        http_endpoint::http_endpoint(const string &url, bool family, bool registration, bool use_regex) : family_url(family),
                                                                                                          reg_compiled(false)
        {
        ...
        http_endpoint::http_endpoint(const http_endpoint &h) : url_complete(h.url_complete),
        ...
        {
            if (!reg_compiled)
                throw std::invalid_argument("Cannot run match. Regex suppressed.");
